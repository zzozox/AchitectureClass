...
public class TClassController extends LogicController<TClassService, TClassDao,TClass,Long> {
    ...
    public List<Student> listStudents(@ApiParam("教学班ID") Long cls_id){
        return  getService().listStudents(cls_id);}
